...
변수의 타입이 정의된 곳으로 이동합니다.
```
사용 예시:
1. const user: User = ... 에서 user 위에서 gy
2. User 인터페이스/타입 정의로 이동

gd vs gy:
- gd: 변수가 선언된 곳으로 이동
- gy: 변수 타입이 정의된 곳으로 이동
```
...
4. <Space>b1~5로 특정 위치 버퍼로 직접 이동
5. <Space>bd로 현재 버퍼 닫기
```
